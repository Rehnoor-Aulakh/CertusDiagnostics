...
export default function Sidebar({ isOpen, setIsOpen }) {
  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 md:relative md:translate-x-0 ${isOpen ? "translate-x-0" : "-translate-x-full"
        }`}
    >
      {/* Logo */}
      <div className="flex items-center justify-center h-16 border-b border-gray-200">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-800">Certus Admin</h1>
          </div>
        </div>
      </div>

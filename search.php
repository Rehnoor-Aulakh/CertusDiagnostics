...
<head>
    ...
    <title>Certus Diagnostics | Search</title>
        ...
        <div class="col-sm-12">
            <form>
                <div class="form-group">
                    <label for="searchbox">Search for a Test:</label>
                    <input type="text" id="searchbox" class="form-control mt-1"/>
                    
                </div>
                <div class="form-group mt-2">
                    <button type="button" class="btn btn-primary btn-block form-control">Search 
                    </button>
                </div>
            </form>
        </div>

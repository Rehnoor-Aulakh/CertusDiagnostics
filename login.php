    ...
    <script>
        function go()
        {
            ...
            if(allok)
            {
                ...
                xhttp.open("GET","login_check.php?username="+username+"&password="+password,true);
                xhttp.send();
            }
        }
                                ...
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    ...
                                    <li class="nav-item dropdown mt-lg-2">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <li><a class="dropdown-item" href="search.html">Go to Store</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="col-sm-7 text-center" style="color:rgb(44, 39, 46)">
                ...
                <form>
                    ...
                    <div class="form-inline">
                        <button class="btn btn-link form-control col-sm-2 ps-3">Forgotten Password?</button>
                        
                    </div>
                    <div class="form-inline">
                        <a href="signup.html" class="btn btn-link form-control col-sm-2">New to Certus? Create Account</a>
                        <label class="text-dark text-center ms-3 my-2" for="checkbox">Remember Me</label>
                        <input type="checkbox" id="checkbox" name="checkbox" class="col-sm-1 form-check-inline">
